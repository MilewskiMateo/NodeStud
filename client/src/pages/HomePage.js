    ...
    <div className={classes.wrapper}>
      <Box className={classes.leftBox} onClick={leftClick}>
        ...
        <p>
          ...
          It was
          popularised in the 1960s with the release of Least sheets containing Lorem Ipsum
          passages, and
      ...
      <Box className={classes.rightBox} onClick={rightClick}>
        ...
        <p>
          If you already know how VideoSpace works check out videos we are offering. Hope you will
